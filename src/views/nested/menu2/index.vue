<template>
  <div class="app-container">
    <div class="filter-container">
      <el-button class="filter-item" style="margin-left: 10px;" type="primary" icon="el-icon-edit" @click="getEmChart">昨天总体用水量变化图</el-button>
    </div>
    <el-table
    ...
    <el-dialog width="100%"  :visible.sync="dialogFormVisible3">
      <yesterday-wm-chart width="100%"/>
    </el-dialog>
  </div>
</template>

<script>
  import yesterdayWmChart from '../components/yesterdayWmChart'
  import { getWmDailyRecordList, deleteWmDailyRecord } from '@/api/compute'
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        getWmDailyRecordList(requestData).then(response => {
      ...
      handleDelete(row){
        ...
        this.$confirm('此操作将删除该条记录, 是否继续?', '提示', {
          ...
          deleteWmDailyRecord(this.temp).then(() => {
