<template>
  <div class="app-container">
    <div class="filter-container">
      <el-button class="filter-item" style="margin-left: 10px;" type="primary" icon="el-icon-edit" @click="getEmChart">上个月总体用水量变化图</el-button>
    </div>
    <el-table
...
<script>
  import WmChart from '../dashboard/admin/components/WmChart'
  import { getWmMonthRecordList, deleteWmMonthRecord } from '@/api/compute'
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        getWmMonthRecordList(requestData).then(response => {
      ...
      handleDelete(row){
        ...
        this.$confirm('此操作将删除该条记录, 是否继续?', '提示', {
          ...
          deleteWmMonthRecord(this.temp).then(() => {
