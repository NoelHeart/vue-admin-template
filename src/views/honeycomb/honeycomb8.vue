<template>
  <div class="app-container">
    ...
    <el-dialog title="创建电表每小时记录" :visible.sync="dialogFormVisible1">
...
<script>
  import { getEmRecordList, updateEmRecord, createEmRecord, deleteEmRecord, EmList } from '@/api/honeycomb'
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        getEmRecordList(requestData).then(response => {
