  ...
  <div class="app-container">
    ...
    <el-dialog title="创建" :visible.sync="dialogFormVisible1">
      <el-form ref="dataForm1" :rules="rules" :model="temp" label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
        <el-form-item label="用电量" prop="yesterUse">
          <el-input v-model="temp.yesterUse"/>
        </el-form-item>
      </el-form>
...
<script>
  import { getHxscreen24YesterList, addHxscreen24Yester, deleteHxscreen24Yester } from '@/api/hxscreen'
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        getHxscreen24YesterList(requestData).then(response => {
      ...
      createData(){
        this.$refs['dataForm1'].validate((valid) => {
          if (valid) {
            addHxscreen24Yester(this.temp).then(() => {
              this.getList()
      ...
      handleDelete(row){
        ...
        this.$confirm('此操作将删除该条记录, 是否继续?', '提示', {
          ...
          deleteHxscreen24Yester(this.temp).then(() => {
