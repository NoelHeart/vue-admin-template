  ...
  <div class="app-container">
    ...
    <el-dialog title="创建" :visible.sync="dialogFormVisible1">
      <el-form ref="dataForm1" :rules="rules" :model="temp" label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="数据值" prop="content">
...
<script>
  import { getHxscreen11List, addHxscreen11, deleteHxscreen11 } from '@/api/hxscreen'
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        getHxscreen11List(requestData).then(response => {
      ...
      handleDelete(row){
        ...
        this.$confirm('此操作将删除该条记录, 是否继续?', '提示', {
          ...
          deleteHxscreen11(this.temp).then(() => {
